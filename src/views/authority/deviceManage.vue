...
<script>
	...
	import { getUserListPage, removeUser, houseRemoveUser, batchRemoveHouse, editHouse, addHouse, getHouseList, toggleFunc, getBasicInfo, getSign, uploadAction, hostBinding, bindingDevice } from '../../api/api';
